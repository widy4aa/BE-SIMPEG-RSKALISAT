...
- [Status Sinkronisasi Endpoint](#status-sinkronisasi-endpoint)
- [Endpoint Umum (Tanpa Login)](#endpoint-umum-tanpa-login)
  - [1. Health Check](#1-health-check)
  - [2. Login](#2-login)
  - [3. Request OTP Lupa Password](#3-request-otp-lupa-password)
  - [4. Reset Password dengan OTP](#4-reset-password-dengan-otp)
- [Endpoint Semua Role (Login Required)](#endpoint-semua-role-login-required)
  - [1. Logout](#1-logout)
  ...
  - [5. Dashboard](#5-dashboard)
    ...
    - [Response Dashboard Untuk Role Direktur](#response-dashboard-untuk-role-direktur)
  ...
  - [5. Diklat](#5-diklat)
    ...
    - [Edit Master Diklat (HRD)](#edit-master-diklat-hrd)
    - [Hapus Master Diklat (HRD)](#hapus-master-diklat-hrd)
  ...
  - [7. Ajukan Perubahan Profile](#7-ajukan-perubahan-profile)
  - [8. Upload Foto Profile (Tanpa Approval)](#8-upload-foto-profile-tanpa-approval)
    - [8.1 Upload File KTP (Tanpa Approval)](#81-upload-file-ktp-tanpa-approval)
    - [8.2 Upload File KK (Tanpa Approval)](#82-upload-file-kk-tanpa-approval)
  - [9. Notifikasi](#9-notifikasi)
    - [9.1 List Notifikasi](#91-list-notifikasi)
    - [9.2 Tandai 1 Notifikasi Sudah Dibaca](#92-tandai-1-notifikasi-sudah-dibaca)
    - [9.3 Tandai Semua Notifikasi Sudah Dibaca](#93-tandai-semua-notifikasi-sudah-dibaca)
  - [10. Riwayat Karir Pendidikan](#10-riwayat-karir-pendidikan)
  ...
  - [11. Riwayat Karir Jabatan](#11-riwayat-karir-jabatan)
  ...
  - [12. Riwayat Karir Pangkat](#12-riwayat-karir-pangkat)
  ...
  - [13. Riwayat Karir SIP](#13-riwayat-karir-sip)
  ...
  - [14. Riwayat Karir STR](#14-riwayat-karir-str)
  ...
  - [15. Riwayat Karir Penugasan Klinis](#15-riwayat-karir-penugasan-klinis)
  ...
  - [16. Data Keluarga](#16-data-keluarga)
  - [1. Get Ringkasan Data Keluarga](#1-get-ringkasan-data-keluarga)
  - [2. Modul Pasangan](#2-modul-pasangan)
    - [A. Get Data Pasangan](#a-get-data-pasangan)
    - [B. Tambah Data Pasangan](#b-tambah-data-pasangan)
    - [C. Ubah Data Pasangan](#c-ubah-data-pasangan)
    - [D. Hapus Data Pasangan](#d-hapus-data-pasangan)
  - [3. Modul Anak](#3-modul-anak)
    - [A. Get Data Anak](#a-get-data-anak)
    - [B. Tambah Data Anak](#b-tambah-data-anak)
    - [C. Ubah Data Anak](#c-ubah-data-anak)
    - [D. Hapus Data Anak](#d-hapus-data-anak)
  - [4. Modul Orang Tua](#4-modul-orang-tua)
    - [A. Get Data Orang Tua](#a-get-data-orang-tua)
    - [B. Tambah Data Orang Tua](#b-tambah-data-orang-tua)
    - [C. Ubah Data Orang Tua](#c-ubah-data-orang-tua)
    - [D. Hapus Data Orang Tua](#d-hapus-data-orang-tua)
  - [5. Modul Kontak Darurat](#5-modul-kontak-darurat)
    - [A. Get Data Kontak Darurat](#a-get-data-kontak-darurat)
    - [B. Tambah Data Kontak Darurat](#b-tambah-data-kontak-darurat)
    - [C. Ubah Data Kontak Darurat](#c-ubah-data-kontak-darurat)
    - [D. Hapus Data Kontak Darurat](#d-hapus-data-kontak-darurat)
  - [6. Modul Tanggungan Lain](#6-modul-tanggungan-lain)
    - [A. Get Data Tanggungan Lain](#a-get-data-tanggungan-lain)
    - [B. Tambah Data Tanggungan Lain](#b-tambah-data-tanggungan-lain)
    - [C. Ubah Data Tanggungan Lain](#c-ubah-data-tanggungan-lain)
    - [D. Hapus Data Tanggungan Lain](#d-hapus-data-tanggungan-lain)
  - [17. Master Data (Form Dropdowns)](#17-master-data-form-dropdowns)
    - [17.1 List Master Data (Semua Role Login)](#171-list-master-data-semua-role-login)
    - [17.2 CRUD Master Data (Khusus HRD)](#172-crud-master-data-khusus-hrd)
  ...
  - [19. STR/SIP (Admin/HRD/Direktur)](#19-strsip-adminhrddirektur)
  - [20. Generate CV](#20-generate-cv)
  - [21. Settings (Admin)](#21-settings-admin)
    - [GET Pengaturan WhatsApp](#get-pengaturan-whatsapp)
    - [PUT Pengaturan WhatsApp](#put-pengaturan-whatsapp)
    - [GET Pengaturan Template WhatsApp](#get-pengaturan-template-whatsapp)
    - [PUT Pengaturan Template WhatsApp](#put-pengaturan-template-whatsapp)
    - [POST Preview Template WhatsApp](#post-preview-template-whatsapp)
  - [21. HRD Manajemen Data Pegawai](#21-hrd-manajemen-data-pegawai)
    - [21.1 Update Data Inti Pegawai](#211-update-data-inti-pegawai)
    - [21.2 Update Data Pribadi Pegawai](#212-update-data-pribadi-pegawai)
    - [21.3 Data Keluarga Pegawai (HRD)](#213-data-keluarga-pegawai-hrd)
...
- [Ringkasan Endpoint Per Role](#ringkasan-endpoint-per-role)
  ...
  - [HRD](#hrd)
  - [Direktur](#direktur)
- [Akun Seeder Untuk Uji Login](#akun-seeder-untuk-uji-login)
- [Quick Test via cURL](#quick-test-via-curl)
- [Postman Collection](#postman-collection)
- [Daftar Request di Collection](#daftar-request-di-collection)
      ...
      "jabatan": [
        {
          ...
          "unit_kerja_id": 28,
          "unit_kerja_nama": "SDM",
          "nama_jabatan": "Koordinator Administrasi SDM",
          "is_current": true,
          "tmt_mulai": "2020-01-01",
          "tmt_selesai": "2023-01-01",
          "link_sk": "/dokumen/jabatan/sk-jabatan-123.pdf",
          "note": ""
        }
      ],
      "pangkat": [
        {
          ...
          "ended_at": null,
          "link_sk": "/dokumen/pangkat/sk-pangkat-123.pdf",
          "note": ""
        }
      ],
      "str": [
