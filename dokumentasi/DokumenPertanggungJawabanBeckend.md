...
| **Data Keluarga** | CRUD Data Pasangan | ✅ | `GET/POST/PATCH/DELETE /api/keluarga/pasangan` |
...
| | CRUD Master Jadwal Diklat | ✅ | `POST/PUT /api/hrd/diklat`, `GET /api/hrd/diklat/{id}/peserta` |
