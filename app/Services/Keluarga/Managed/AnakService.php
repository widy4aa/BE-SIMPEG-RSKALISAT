...
use App\Repositories\Keluarga\Managed\AnakRepository;
use Illuminate\Http\UploadedFile;
use InvalidArgumentException;

class AnakService extends BaseKeluargaService
{
    public function __construct(protected readonly AnakRepository $repository) {}
