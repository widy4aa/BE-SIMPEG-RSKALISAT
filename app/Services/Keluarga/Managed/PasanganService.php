...
use App\Repositories\Keluarga\Managed\PasanganRepository;
use Illuminate\Http\UploadedFile;
use InvalidArgumentException;

class PasanganService extends BaseKeluargaService
{
    public function __construct(protected readonly PasanganRepository $repository) {}
