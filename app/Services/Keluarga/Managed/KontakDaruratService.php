...
use App\Repositories\Keluarga\Managed\KontakDaruratRepository;
use InvalidArgumentException;

class KontakDaruratService extends BaseKeluargaService
{
    public function __construct(protected readonly KontakDaruratRepository $repository) {}
