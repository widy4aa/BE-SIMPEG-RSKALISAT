...
class HrdPangkatService extends BaseHrdRiwayatKarirService
{
    ...
    public function updatePangkat(int $id, int $pegawaiId, array $payload, ?UploadedFile $file = null): array
    {
        ...
        $pangkatData = [];
        if (array_key_exists('nama_pangkat', $payload)) {
            $pangkatData['nama'] = (string) $payload['nama_pangkat'];
        }
        if (array_key_exists('pejabat_penetap', $payload)) {
            $pangkatData['pejabat_penetap'] = $payload['pejabat_penetap'];
        }
        if (array_key_exists('tmt_sk', $payload)) {
            $pangkatData['tmt_sk'] = $payload['tmt_sk'];
        }
        ...
        if (array_key_exists('started_at', $payload)) {
            $pivotData['started_at'] = $payload['started_at'];
        }
        if (array_key_exists('ended_at', $payload)) {
            $pivotData['ended_at'] = $payload['ended_at'];
        }
