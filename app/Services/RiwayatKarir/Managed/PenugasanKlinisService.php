...
use App\Repositories\RiwayatKarir\Managed\PenugasanKlinisRepository;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\UploadedFile;

class PenugasanKlinisService extends BaseRiwayatKarirService
{
    public function __construct(protected readonly PenugasanKlinisRepository $repository) {}
