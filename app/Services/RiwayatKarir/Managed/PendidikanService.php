...
use App\Repositories\RiwayatKarir\Managed\PendidikanRepository;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\UploadedFile;

class PendidikanService extends BaseRiwayatKarirService
{
    public function __construct(protected readonly PendidikanRepository $repository) {}
