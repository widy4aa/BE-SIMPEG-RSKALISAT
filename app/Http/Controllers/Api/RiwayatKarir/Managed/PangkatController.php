...
use App\Services\RiwayatKarir\Managed\PangkatService;
...
class PangkatController extends Controller
{
    ...
    {
        try {
            $data = $this->service->getPangkat($id);
            return response()->json(['success' => true, 'message' => 'Data riwayat pangkat berhasil diambil.', 'data' => $data]);
        } catch (\Exception $e) {
